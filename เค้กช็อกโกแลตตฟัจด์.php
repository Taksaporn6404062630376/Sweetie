...
<html>
    <head>
        <title>เค้กช็อกโกแลตตฟัจด์</title>
        <meta charset="utf-8">
    ...
    <body>  
        ...
        <br><br>
        <hr><h1>เค้กช็อกโกแลตตฟัจด์</h1> <hr><br><br>
        <?php
        $stmt = $pdo->prepare("SELECT menuID, menuname, Size_Pound_or_Piece, detail, price FROM menu WHERE menuname LIKE 'เค้กช็อกโกแลตตฟัจด์' AND menuID = 3;");
        $stmt->execute();
