...
<html>
    ...
    <body>
        ...
        <br><br>
        <hr><h1>เค้กสตรอว์เบอร์รี</h1> <hr><br><br>
        <?php
        $stmt = $pdo->prepare("SELECT menuID, menuname, Size_Pound_or_Piece, detail, price FROM menu WHERE menuname LIKE 'เค้กสตรอว์เบอร์รี' AND menuID = 7;");
        $stmt->execute();
